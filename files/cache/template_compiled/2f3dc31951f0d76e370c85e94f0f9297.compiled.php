...
<!--#Meta:layouts/global/css/fontawesome-free-5.15.2/all.css--><?php $__tmp=array('layouts/global/css/fontawesome-free-5.15.2/all.css','','','');Context::loadFile($__tmp);unset($__tmp); ?>
		...
		<div class="inner_xe">
			<div class="HeaderTop">
				<div class="inner_HeaderTop">		
					<ul class="account">
						<li class="li_account"><a class="offering" href="#" onclick="offering();">OFFERING/온라인헌금</a></li>
				...
				<?php if($__Context->layout_info->layout_style=='ec'||$__Context->layout_info->layout_style=='ece'){ ?><div class="e1 lnb">
					<?php if($__Context->layout_info->layout_style=='ece'){ ?><div class="lnb_widget">
						<div class="in_lnb_widget">
							<a href="<?php echo $__Context->layout_info->preach ?>"><img src="/layouts/global/img/<?php echo $__Context->lang_type ?>_preach.jpg" width="240" height="227" alt="설교안내" /></a>
						</div>
						<div class="in_lnb_widget">
							<a href="<?php echo $__Context->layout_info->worship ?>"><img src="/layouts/global/img/<?php echo $__Context->lang_type ?>_worship.jpg" width="240" height="195" alt="예배안내" /></a>
						</div>
						<div class="in_lnb_widget">
							<a href="/xe/Praise_Worship"><img src="/layouts/global/img/<?php echo $__Context->lang_type ?>_banner1.jpg"  alt="<?php echo $__Context->layout_info->banner_alt1 ?>" /></a>
						</div>
						<div class="in_lnb_widget">
							<a href="/xe/calendar"><img src="/layouts/global/img/<?php echo $__Context->lang_type ?>_banner2.jpg" alt="<?php echo $__Context->layout_info->banner_alt2 ?>" /></a>
						</div>
						<!-- <div class="celebration">
							<h2>찬양과 경배</h2>
							<img class="zbxe_widget_output" widget="content" skin="global" colorset="white" content_type="document" module_srls="<?php echo $__Context->layout_info->celebration ?>" list_type="normal" tab_type="none" markup_type="list" list_count="5" page_count="1" subject_cut_size="26" option_view="title" show_browser_title="N" show_comment_count="N" show_trackback_count="N" show_category="N" show_icon="N" order_target="regdate" order_type="desc" thumbnail_type="crop" />
						</div> -->
					</div><?php } ?>
...
$__Context->menu_depth3 = $__Context->val;
				...
				<?php if($__Context->layout_info->layout_style==ece){ ?><div class="e2">
					<div class="lnb_widget">
						<div class="in_lnb_widget gallery">
							...
							<a target="_blank" href="http://www.facebook.com/grchawaii"><img src="/layouts/global/img/facebook.png" width="200" height="49" alt="글로벌리바이벌 페이스북 바로가기" /></a>
							<a target="_blank" href="https://www.youtube.com/channel/UCCIDbDuXKDnCcXnMwRAitfA" class="btn_youtube">
							    <i class='fab fa-youtube'></i>
							    <small>YouTube Chanel</small>
							    G.R.C Hawaii
							</a>
						</div>
					</div>
			...
			<div class="footer">	
				...
				<p>
					Office : 99-860 Iwaena St, Suite 201, Aiea, HI 96701.    Tel : 808-487-8252    E-mail :  <a href="mailto:amtc21c@yahoo.com" style="text-decoration:none; color:#000">amtc21c@yahoo.com</a><br>
Sunday service : 1500 Kapiolani Blvd, 102E Honolulu, HI 96816 / 9:30AM<br>
					Counsel : 808-551-8461    Assistant Pastor : 808-391-5529<br> 
Facebook : <a href="http://www.facebook.com/grchawaii" target="_blank" style="text-decoration:none; color:#000">www.facebook.com/grchawaii</a>    YouTube : <a href="https://www.youtube.com/channel/UCCIDbDuXKDnCcXnMwRAitfA" target="_blank" style="text-decoration:none; color:#000">G.R.C.Hawaii</a><br>
					Copyright(C). 2013 GlobalRevival Church. all rights reserved.     powered by<a href="http://www.hosannaweb.net"><img src="<?php echo getSiteUrl() ?>/common/img/hosanna-logo_s.jpg" border="0"align="absmiddle"></a>
				</p>			</div>
		</div>
	</div>