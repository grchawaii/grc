...
<div class="xenara_layout" style="background:none;">
  ...
  <?php } ?>
  <img class="zbxe_widget_output" widget="language_select" skin="default" colorset="white" />
  </div>
  <div style="position:relative; width:980px; height:80px; margin:0px auto; overflow:hidden;">
    <div id="global">
      <ul id="menu">
...
<div id="topmenu"></div> 
 
    <div id="head_other" style="border:1px solid red;">
      <table border="0" cellspacing="0"><tbody><tr>
        <td height="80" width="220" valign="middle" align="left">
          <?php if($__Context->layout_info->header_logo){ ?>
            <a href="<?php echo $__Context->layout_info->homepage_url ?>" style="width:181px; height:56px; display:block;">
              <img src="<?php echo $__Context->layout_info->header_logo ?>" border="0" style="width:181px; height:56px;">
            </a>
          <?php } ?>
        </td>
...
if($__Context->val['selected']){ ?> on<?php } ?>">
  ...
  <?php }else{ ?>
    ...
    <?php if($__Context->layout_info->main_header_content_widget1){ ?><div id="header_content1" class="main_header_content_widget1">
    ...
    <?php if($__Context->layout_info->main_content_type=='fix_content' && !$__Context->act){ ?>
      <div id="content" class="content" style="position:relative; width:980px; padding:30px 0px 0px 0px; margin:0px auto 0px auto;">
      <table border="0" cellspacing="0" width="100%" style="border:0px;"><tbody><tr>
        <td width="284" align="left" valign="top" class="main_left">
          <?php if($__Context->layout_info->main_left_content){ ?><div class="main_left_content">
...
if($__Context->val['selected']){ ?> on<?php } ?>">
        ...
        <td width="368" align="left" valign="top" class="main_middle">
          ...
          <?php if($__Context->layout_info->main_middle_content_widget2){ ?><div class="main_middle_content_widget2"  style="margin:30px 20px 0px 20px;">
            <img class="zbxe_widget_output" widget="content_xenara" skin="widget_content_biz_layout_v1_0_w2" colorset="default" content_type="document" module_srls="<?php echo $__Context->layout_info->main_middle_content_widget2 ?>" list_type="image_title_content" tab_type="tab_top" markup_type="table" list_count="3" cols_list_count="3" page_count="1" subject_cut_size="30" content_cut_size="100" option_view="title,regdate,thumbnail,content" show_browser_title="Y" show_comment_count="Y" show_trackback_count="Y" show_category="Y" show_icon="Y" duration_new="24" order_target="list_order" order_type="asc" thumbnail_type="crop" thumbnail_width="110" thumbnail_height="75" map_provider="naver" shopintro_extra="N" />
          </div><?php } ?>
        ...
        <td width="328" align="left" valign="top" class="main_right">
          <?php if($__Context->layout_info->main_right_content_widget1){ ?><div class="main_right_content_widget1">
