...
${'document_srl43_argument'} = new ConditionArgument('document_srl', $args->document_srl, 'in');
...
,new ConditionWithArgument('`extra_vars`.`document_srl`',$document_srl43_argument,"in", 'and')
